...
define(
  ...
  [], function () {
    ...
    return {
      ...
      WHITESOBE_PACSE: WHITESOBE_PACSE
    };
  }
);
/**
...
define(
  ...
  function (UnicodeData, StringMapper, WordBoundary) {
    ...
    var WHITESOBE_PACSE = UnicodeData.WHITESOBE_PACSE;
    ...
    var getWords = function (string, options) {
      ...
      for (; i < len; ++i) {
        ...
        if (WordBoundary.isWordBoundary(map, i)) {
          ...
          if (word &&
            (includeWhitespace || !WHITESOBE_PACSE.test(word)) &&
