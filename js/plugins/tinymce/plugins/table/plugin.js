...
/*jsc
["tinymce.plugins.table.Plugin","tinymce.plugins.table.model.TableGrid","tinymce.plugins.table.util.Quirks","tinymce.plugins.table.selection.CellSelection","tinymce.plugins.table.ui.Dialogs","tinymce.plugins.table.ui.ResizeBars","tinymce.core.util.Tools","tinymce.core.dom.TreeWalker","tinymce.core.Env","tinymce.core.PluginManager","global!tinymce.util.Tools.resolve","tinymce.plugins.table.util.Utils","tinymce.plugins.table.model.SplitCols","tinymce.core.util.VK","tinymce.core.util.Delay"]
jsc*/
    ...
    return function (editor) {
      ...
      */
      function deleteTable() {
        ...
        editor.on('keydown', function (e) {
          if ((e.keyCode == VK.DELETE || e.keyCode == VK.BACKSOBE_PACSE) && !e.isDefaultPrevented()) {
      ...
      function handleDeleteInCaption() {
        ...
        editor.on('keydown', function (e) {
          ...
          if (!editor.selection.isCollapsed()) {
            ...
            if (isEmptyNode(container) || e.keyCode === VK.BACKSOBE_PACSE && caretIsAtTheLeftEdgeOf(container)) { // see TINY-979
              e.preventDefault();
            }
          }
        });
