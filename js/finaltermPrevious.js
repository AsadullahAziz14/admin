...
function get_prgsemestersfinalterm(idprg) {  
	...
	$.ajax({  
		type: "POST",  
		url: "include/ajax/finalterm/previous/get_prgsemestersfinalterm.php",  
		data: "idprg="+idprg,  
...
function get_prgfinaltiming(semester, idprg) {  
	...
	$.ajax({  
		type: "POST",  
		url: "include/ajax/finalterm/previous/get_prgfinaltiming.php",  
...
function get_sesionfinaltiming(timing, idprg, semester) {  
	...
	$.ajax({  
		type: "POST",  
		url: "include/ajax/finalterm/previous/get_sesionfinaltiming.php",  
...
function get_studentsfinaltiming(adsess, idprg, semester, timing) {  
	...
	$.ajax({  
		type: "POST",  
		url: "include/ajax/finalterm/previous/get_studentsfinaltiming.php",  
...
function get_coursfinaldetail(idcurs, idprg, semester, adsess, timing) {  
	...
	$.ajax({  
		type: "POST",  
		url: "include/ajax/finalterm/previous/get_coursfinaldetail.php",  
...
function get_coursetype(curstype, idprg, semester, timing, adsess, idcurs) {  
	...
	$.ajax({  
		type: "POST",  
		url: "include/ajax/finalterm/previous/get_coursetype.php",  
...
function get_studentsfinaltimingsection(section, idprg, semester, timing, idcurs, adsess, curstype) {  
	...
	$.ajax({  
		type: "POST",  
		url: "include/ajax/finalterm/previous/get_studentsfinaltimingsection.php",  
