...
define(
  ...
  function (VK, RangeUtils, TreeWalker, NodePath, Node, Entities, Env, Tools, Delay, CaretContainer, CaretPosition, CaretWalker) {
    return function (editor) {
      var each = Tools.each;
      var BACKSOBE_PACSE = VK.BACKSOBE_PACSE, DELETE = VK.DELETE, dom = editor.dom, selection = editor.selection,
      ...
      function emptyEditorWhenDeleting() {
        ...
        editor.on('keydown', function (e) {
          ...
          if (!isDefaultPrevented(e) && (keyCode == DELETE || keyCode == BACKSOBE_PACSE)) {
      ...
      function removeHrOnBackspace() {
        editor.on('keydown', function (e) {
          if (!isDefaultPrevented(e) && e.keyCode === BACKSOBE_PACSE) {
      ...
      function removeBlockQuoteOnBackSpace() {
        ...
        editor.on('keydown', function (e) {
          ...
          if (isDefaultPrevented(e) || e.keyCode != VK.BACKSOBE_PACSE) {
            return;
          }
