<?php 
	...
	include_once("include/Staffs/obe/paracticals/query.php");
...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="obeparacticals.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="obeparacticals.php?view=add"><i class="icon-plus"></i> Add Paractical</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
...
echo '<div class="widget-content">';
			...
			include_once("include/Staffs/obe/paracticals/list.php");
           	include_once("include/Staffs/obe/paracticals/add.php");
            include_once("include/Staffs/obe/paracticals/edit.php");
            include_once("include/Staffs/obe/paracticals/report.php");		
			include_once("include/Staffs/obe/paracticals/result/add.php");		
			include_once("include/Staffs/obe/paracticals/result/edit.php");
