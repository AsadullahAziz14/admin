...
//Check If User has rights
	...
	require_once("include/Staffs/inventory/vendors/query.php");
						...
						<div class="container-fluid">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<form class="navbar-form navbar-left form-small" action="" method="get">
									...
									<a href="inventory-vendor.php" class="btn btn-purple"><i class="icon-list"></i> All</a>';
									if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '191', 'add' => '1'))) { 
										echo ' <a class="btn btn-success" href="inventory-vendor.php?view=add"><i class="icon-plus"></i> Add Vendor</a>';
									}
									echo '
								</form>
							</div>
							...
							<div class="col-lg-12">
									<div class="widget">
										<div class="widget-content">';
											...
											require_once("include/Staffs/inventory/vendors/list.php");
											require_once("include/Staffs/inventory/vendors/add.php");
											require_once("include/Staffs/inventory/vendors/edit.php");
										echo'
									</div>
								</div>
							</div>
