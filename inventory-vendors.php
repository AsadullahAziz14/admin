<?php 
	...
	include ("include/vendors/query.php");
...
//----------------------------------------
echo '<title>Manage Items - '.TITLE_HEADER.'</title>
<!-- Matter -->
<div class="matter">
<!--WI_CLIENTS_SEARCH-->
...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="inventory-vendors.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="inventory-vendors.php?view=add"><i class="icon-plus"></i> Add Vendor</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
...
//---------------------------------------------------
            include ("include/vendors/list.php");
            include ("include/vendors/add.php");
            include ("include/vendors/edit.php");
//---------------------------------------------------         
echo'
        </div>
        <!-- container-fluid -->
