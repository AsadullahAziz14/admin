...
//Check If User has rights
	...
	require_once("include/Staffs/inventory/sub_category/query.php");
	...
	if(($srch)) { 
		$sql2 		.= " AND (sub_category_name LIKE '%".$srch."%')"; 
		$sqlstring	.= "&srch=".$srch."";
	}
    if(($status_srch)) { 
		$sql2 		.= " AND sub_category_status = '".$status_srch."'"; 
		$sqlstring	.= "&status_srch=".$status_srch."";
	}
				echo '
				<title>Manage Sub-Category - '.TITLE_HEADER.'</title>
				<!-- Matter -->
				<div class="matter">
					<!--WI_CLIENTS_SEARCH-->
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<form class="navbar-form navbar-left form-small" action="" method="get">
									...
									if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '191', 'add' => '1'))) { 
										echo ' <a class="btn btn-success" href="inventory-sub_category.php?view=add"><i class="icon-plus"></i> Add Sub-Category</a>';
									}
									echo '
								</form>
							</div>
							...
							<div class="col-lg-12">
									<div class="widget">
										<div class="widget-content">';
											...
											require_once("include/Staffs/inventory/sub_category/list.php");
											require_once("include/Staffs/inventory/sub_category/add.php");
											require_once("include/Staffs/inventory/sub_category/edit.php");
										echo'
									</div>
								</div>
							</div>
