<?php 
	...
	include ("include/demand/query.php");
...
//----------------------------------------
echo '<title>Manage Demand - '.TITLE_HEADER.'</title>
<!-- Matter -->
<div class="matter">
<!--WI_CLIENTS_SEARCH-->
...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="demand.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="demand.php?view=add"><i class="icon-plus"></i> Add Demand</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
...
//---------------------------------------------------
            include ("include/demand/list.php");
            include ("include/demand/add.php");
            include ("include/demand/edit.php");
//---------------------------------------------------         
echo'
        </div>
        <!-- container-fluid -->
