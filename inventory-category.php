						...
						<div class="container-fluid">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<form class="navbar-form navbar-left form-small" action="" method="get">
									...
									<a href="inventory-category.php" class="btn btn-purple"><i class="icon-list"></i> All</a>';
									if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '191', 'add' => '1'))) { 
										echo ' <a class="btn btn-success" href="inventory-category.php?view=add"><i class="icon-plus"></i> Add Category</a>';
									}
									echo '
								</form>
							</div>
							...
							<div class="col-lg-12">
									<div class="widget">
										<div class="widget-content">';
											...
											require_once("include/Staffs/inventory/category/list.php");
											require_once("include/Staffs/inventory/category/add.php");
											require_once("include/Staffs/inventory/category/edit.php");
										echo'
									</div>
								</div>
							</div>
