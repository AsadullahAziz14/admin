...
//Check If User has rights
	...
	require_once("include/Staffs/inventory/demand_stationary/query.php");
	...
	if((($_SESSION['userlogininfo']['LOGINTYPE'] == 8) || ($_SESSION['userlogininfo']['LOGINTYPE'] == 9))) { 
						...
						<div class="container-fluid">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<form class="navbar-form navbar-left form-small" action="" method="get">
									...
									<a href="inventory-demand_stationary.php" class="btn btn-purple"><i class="icon-list"></i> All</a>';
									if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '191', 'add' => '1'))) { 
										echo ' <a class="btn btn-success" href="inventory-demand_stationary.php?view=add"><i class="icon-plus"></i> Add Demand</a>';
									}
									echo '
								</form>
							</div>
							...
							<div class="col-lg-12">
									<div class="widget">
										<div class="widget-content">';
											...
											require_once("include/Staffs/inventory/demand_stationary/list.php");
											require_once("include/Staffs/inventory/demand_stationary/add.php");
											require_once("include/Staffs/inventory/demand_stationary/edit.php");
										echo'
									</div>
								</div>
							</div>
		...
		require_once("include/Staffs/inventory/demand_stationary/forward.php");
		echo '
