<?php 
	...
	include ("include/categories/query.php");
...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a data-toggle="modal" class="btn btn-success" href="inventory-categories.php?view=add"><i class="icon-plus"></i> Add Category</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
