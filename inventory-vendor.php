							...
							<div class="col-lg-12">
									<div class="widget">
										<div class="widget-content">';
											...
											require_once("include/Staffs/inventory/vendor/list.php");
											require_once("include/Staffs/inventory/vendor/add.php");
											require_once("include/Staffs/inventory/vendor/edit.php");
										echo'
									</div>
								</div>
							</div>
