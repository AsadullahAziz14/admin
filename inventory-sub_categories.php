<?php 
	...
	include ("include/sub_categories/query.php");
...
//----------------------------------------
echo '<title>Manage Categories - '.TITLE_HEADER.'</title>
<!-- Matter -->
<div class="matter">
<!--WI_CLIENTS_SEARCH-->
...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="inventory-sub_categories.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="inventory-sub_categories.php?view=add"><i class="icon-plus"></i> Add Sub-Category</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
...
//---------------------------------------------------
            include ("include/sub_categories/list.php");
            include ("include/sub_categories/add.php");
            include ("include/sub_categories/edit.php");
//---------------------------------------------------         
echo'
        </div>
        <!-- container-fluid -->
