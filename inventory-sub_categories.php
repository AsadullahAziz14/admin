...
//Check If User has rights
	...
	require_once("include/Staffs/inventory/sub_categories/query.php");
							...
							<div class="col-lg-12">
									<div class="widget">
										<div class="widget-content">';
											...
											require_once("include/Staffs/inventory/sub_categories/list.php");
											require_once("include/Staffs/inventory/sub_categories/add.php");
											require_once("include/Staffs/inventory/sub_categories/edit.php");
										echo'
									</div>
								</div>
							</div>
