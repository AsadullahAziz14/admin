						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-content">';
                                    ...
                                    include_once("include/Staffs/inventory/items/list.php");
                                    include_once("include/Staffs/inventory/items/add.php");
                                    include_once("include/Staffs/inventory/items/edit.php");
									echo '
								</div>
							</div>
						</div>
