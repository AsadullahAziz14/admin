...
//Check If User has rights
	...
	require_once("include/Staffs/inventory/item/query.php");
	...
	if(($srch)) { 
		$sql2 		.= " AND (item_title LIKE '%".$srch."%')"; 
		$sqlstring	.= "&srch=".$srch."";
	}
    if(($status_srch)) { 
		$sql2 		.= " AND item_status = '".$status_srch."'"; 
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<form class="navbar-form navbar-left form-small" action="" method="get">
								...
								<a href="inventory-item.php" class="btn btn-purple"><i class="icon-list"></i> All</a>';
								if(($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '191', 'add' => '1'))) { 
									echo ' <a class="btn btn-success" href="inventory-item.php?view=add"><i class="icon-plus"></i> Add Item</a>';
								}
								echo '
							</form>
						</div>
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-content">';
                                    ...
                                    require_once("include/Staffs/inventory/item/list.php");
                                    require_once("include/Staffs/inventory/item/add.php");
                                    require_once("include/Staffs/inventory/item/edit.php");
									echo '
								</div>
							</div>
						</div>
