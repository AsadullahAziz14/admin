...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="sub_categories.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="sub_categories.php?view=add"><i class="icon-plus"></i> Add Sub-Category</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
