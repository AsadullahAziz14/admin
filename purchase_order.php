<?php 
	...
	include ("include/purchase_order/query.php");
...
//----------------------------------------
echo '<title>Manage PO - '.TITLE_HEADER.'</title>
<!-- Matter -->
<div class="matter">
<!--WI_CLIENTS_SEARCH-->
...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="purchase_order.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="purchase_order.php?view=add"><i class="icon-plus"></i> Add PO</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
...
//---------------------------------------------------
            include ("include/purchase_order/list.php");
            include ("include/purchase_order/add.php");
            include ("include/purchase_order/edit.php");
            include ("include/purchase_order/forward_po.php");
