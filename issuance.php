...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="issuance.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="issuance.php?view=add"><i class="icon-plus"></i> Add Issuance</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
