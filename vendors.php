...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="vendors.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="vendors.php?view=add"><i class="icon-plus"></i> Add Vendor</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
