<?php 
	...
	include ("include/items/query.php");
...
<form class="navbar-form navbar-left form-small" action="" method="get">
	...
	<a href="items.php" class="btn btn-purple"><i class="icon-list"></i> All</a>
	<a data-toggle="modal" class="btn btn-success" href="items.php?view=add"><i class="icon-plus"></i> Add Item</a>
</form>
</div>
<!-- /.navbar-collapse -->
</div>
...
//---------------------------------------------------
            include ("include/items/list.php");
            include ("include/items/add.php");
            include ("include/items/edit.php");
//---------------------------------------------------         
echo'
        </div>
        <!-- container-fluid -->
