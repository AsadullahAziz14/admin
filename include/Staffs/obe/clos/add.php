...
{ 
	...
	<div class="row">
	<div id="addNewCLOModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
	<form class="form-horizontal" action="obeclos.php" method="POST" id="addNew" enctype="multipart/form-data">
	<div class="modal-content">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
		<button type="button" class="full-screen-modal close" aria-hidden="true"><i class="icon-fullscreen"></i></button>
		<h4 class="modal-title" style="font-weight:700;"> Add CLO Details</h4>
	</div>
	<div class="modal-body">
		...
		if(LIBREL_ARTS == 1)
		{
			...
			<div class="form-group">
				<label class="control-label req col-lg-12" style="width:150px;"><b>Section(s)</b></label>
				<div class="col-lg-12">
					<select id="sections" class="select2" name="sections[]" style="width:100%" multiple>';
						foreach ($sections as $itemsection) {
							echo' <option value="'.$itemsection.'">'.$itemsection.'</option> ';
						}
						echo '
					</select>
				</div>
		...
		<div class="form-group">
			<label for="clo_statement" class="control-label req col-lg-12" style="width:150px;"> <b>CLO Statement</b></label>
			<div class="col-lg-12">
