      ...
      <thead>
        ...
        <tr>
          ...
          $pac_sqllms = $dblms->querylms("SELECT pac_id, pac_statement, COUNT(kpi_id) as countKpi
                                            FROM ".OBE_KPIS." as kpi , ".OBE_PACS." as pac
                                            Where kpi.id_pac = pac.pac_id 
                                            GROUP BY kpi.id_pac;");
          ...
          if(!empty($kpiClosArray)) {
            ...
            $plo_sqllms = $dblms->querylms("SELECT GROUP_CONCAT(id_plo) as ploIds
                                              FROM ".OBE_CLOS."
                                              Where clo_id IN (".implode(',',$cloIdsArray).") AND clo_id != ''
                                          ");
        ...
        <tr>
          ...
          while($row_sqllms = mysqli_fetch_array($sqllms)) {
            ...
            echo '<th style="vertical-align: middle;" rowspan= "3">CLO'.$row_sqllms['clo_number'].'</th>';
          }
          ...
          while($row_sqllms = mysqli_fetch_array($sqllms)) {
            ...
            echo '<th style="vertical-align: middle;" rowspan= "3">PLO'.$row_sqllms['plo_number'].'</th>';              
          }
          echo '
        </tr>
        ...
        <tr>
          ...
          foreach ($kpiMarksArray as $kpi => $marks) {
            echo '<th style="vertical-align: middle;" >'.$marks.'</th>';
          ...
          echo '<th>'.$relative_paracticalMarks.'</th>';
