            ...
            <tbody>';
               ...
               while($valueDemand = mysqli_fetch_array($queryDemand)) {
                  ...
                  <tr>
                     ...
                     $queryDemandItem = $dblms->querylms("SELECT id, id_demand, sum(quantity_demanded) as quantity_demanded
                                                            FROM ".SMS_DEMAND_ITEM_JUNCTION." 
                                                            WHERE id_demand = ".$valueDemand['demand_id']."
                                                         ");
                     $valueDemandItem = mysqli_fetch_array($queryDemandItem);
                     echo '
                     <td style="vertical-align: middle;" nowrap="nowrap">'.$valueDemandItem['quantity_demanded'].'</td>
