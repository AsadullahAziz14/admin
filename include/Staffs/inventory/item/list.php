		...
		if($count > $Limit) {
			...
			<div class="widget-foot">
				...
				if($lastpage > 1) {	
					...
					//previous button
					if ($page > 1) {
						$pagination.= '<li><a href="inventory-item.php?page='.$prev.$sqlstring.'">Prev</a></li>';
					}
					//pages	
					if ($lastpage < 7 + ($adjacents * 3)) {	
						...
						if ($counter == $page) {
							...
							$pagination.= '<li><a href="inventory-item.php?page='.$counter.$sqlstring.'">'.$counter.'</a></li>';
						}
						}
						...
						$pagination.= '<li><a href="inventory-item.php?page='.$lpm1.$sqlstring.'">'.$lpm1.'</a></li>';
						$pagination.= '<li><a href="inventory-item.php?page='.$lastpage.$sqlstring.'">'.$lastpage.'</a></li>';	
						} else if($lastpage - ($adjacents * 3) > $page && $page > ($adjacents * 3)) { //in middle; hide some front and some back
							$pagination.= '<li><a href="inventory-item.php?page=1'.$sqlstring.'">1</a></li>';
							$pagination.= '<li><a href="inventory-item.php?page=2'.$sqlstring.'">2</a></li>';
							$pagination.= '<li><a href="inventory-item.php?page=3'.$sqlstring.'">3</a></li>';
							$pagination.= '<li><a href="#"> ... </a></li>';
				...
				//next button
				if ($page < $counter - 1) {
					$pagination.= '<li><a href="inventory-item.php?page='.$next.$sqlstring.'">Next</a></li>';
				} else {
					$pagination.= "";
				}
				echo $pagination;
