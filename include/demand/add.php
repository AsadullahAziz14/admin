...
{ 
	...
	<div class="row">
		<div class="modal-dialog" style="width:90%;">
			<form class="form-horizontal" action="demand.php" method="POST" enctype="multipart/form-data" autocomplete="off">
									...
									<div class="col-sm-61">
										...
										<select class="form-control" name="item['.($i+1).']" required>
											...
											while($rowstd2 = mysqli_fetch_array($sqllms2)) {
												echo '<option value="'.$rowstd2['item_id'].'">'.$rowstd2['item_code'].' '.$rowstd2['item_title'].'</option>';
											}
									echo '
										</select>
									</div>
