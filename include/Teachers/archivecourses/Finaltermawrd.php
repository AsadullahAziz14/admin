...
<div class="row">
	<div class="col-lg-12">
		<div class="tabs-sub-nav">
			...
			<span class="pull-right"><a class="btn btn-success" href="archive.php?id='.$_GET['id'].'&prgid='.$_GET['prgid'].'&timing='.$_GET['timing'].'&semester='.$_GET['semester'].$sectionlink.'"> Back to Course </a></span>
