...
//--------------------------------------------------
	$sqllmsassign  = $dblms->querylms("SELECT at.id, at.lectureno, at.id_curs, at.id_teacher, at.dated    
										...
										$seccursquery AND std.id_prg = '".cleanvars($rowsurs['id_prg'])."'
...
<tr>
	...
	<td style="width:80px; text-align:center;">
		...
		<a class="btn btn-xs btn-info" href="courses.php?id='.$_GET['id'].'&prgid='.$_GET['prgid'].'&timing='.$_GET['timing'].'&semester='.$_GET['semester'].$secthref.'&view=Attendance&editid='.$rowassign['id'].'"><i class="icon-pencil"></i></a> 
