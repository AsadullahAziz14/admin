...
//------------------------------------------------
	$sqllmscheck  = $dblms->querylms("SELECT id  
										...
										AND timing = '".cleanvars($_GET['timing'])."' 
...
if(mysqli_num_rows($sqllmscheck)>0) { 
	...
	$sqllmsannoucements  = $dblms->querylms("INSERT INTO ".COURSES_ANNOUCEMENTS." (
																		status								, 
																		dated								, 
																		caption								, 
																		detail								,
...
<div class="row">
	<div class="col-lg-12">
		<div class="tabs-sub-nav">
			...
			<a data-toggle="modal" class="btn btn-mid btn-info pull-right" href="#cursAddAnnoucementModal"><i class="icon-plus"></i> Add Announcement </a>
...
<div class="widget-content">';
	$sqllmsannouce  = $dblms->querylms("SELECT * 
										...
										AND id_teacher = '".cleanvars($rowsstd['emply_id'])."' ORDER BY dated DESC");
//--------------------------------------------------
