...
$sqllmsdetails  = $dblms->querylms("SELECT c.curs_code, c.curs_name, p.prg_name, t.semester, t.timing, t.section, 
										...
										AND t.status = '1' AND t.examterm = '2' 
...
//------------------------------------------------
	...
	<tr>
		...
		<td style="vertical-align:middle;text-align:center;width:120px;">'.addOrdinalNumberSuffix($rowcurs['semester']).' ('.(get_programtiming($rowcurs['timing'])).')</td>
			<td style="vertical-align:middle;text-align:center;width:70px;">'.($rowcurs['section']).'</td>
