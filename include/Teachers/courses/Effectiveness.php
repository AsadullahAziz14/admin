...
<div class="row">
	<div class="col-lg-12">
		<div class="tabs-sub-nav">
			<span class="pull-left"><h3  style="font-weight:700;">Soft Skills & Personal Effectiveness</h3></span> <a class="btn btn-mid btn-purple pull-right" href="courses.php?id='.$_GET['id'].'"><i class="icon-list"></i> Back</a> 
...
// course info
$sqllmsinfo  = $dblms->querylms("SELECT id, effectiveness, effectiveness_date
										FROM ".COURSES_INFO."   										 
...
//------------------------------------------------
if($rowscinfo['effectiveness']) {
	$effectiveness = $rowscinfo['effectiveness'];
} else {
	$effectiveness = '';
}
//-----------------------------------------
...
<div class="modal-header">
	...
	<h4 class="modal-title" style="font-weight:700;"> Soft Skills & Personal Effectiveness</h4>
</div>

<div class="modal-body">

	<div class="form-group">
		<label class="control-label req col-lg-12" style="width:150px;"><b> Effectiveness</b></label>
		<div class="col-lg-12">
			<textarea class="form-control ckeditor" id="effectiveness" name="effectiveness" style="height:150px !important;" required="required" autocomplete="off">'.$effectiveness.'</textarea>
		</div>
	</div>
...
<div class="modal-footer">
	...
	<input class="btn btn-primary" type="submit" value="Save Record" id="effectiveness_submit" name="effectiveness_submit">
</div>
