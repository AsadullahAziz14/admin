...
//------------------------------------------------
if(empty(removeWhiteSpace($_GET['prgid'])) || empty(removeWhiteSpace($_GET['timing'])) || empty(removeWhiteSpace($_GET['semester'])) || empty(removeWhiteSpace($_POST['id_teacher'])) || (count( array_filter($_POST['marks_obtained'])) < 1)) {
//------------------------------------------------
