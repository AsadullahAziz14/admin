...
<div class="row">
<div id="cursAddAnnoucementModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<form class="form-horizontal" action="#" method="post" id="addAnnoucement" enctype="multipart/form-data" OnSubmit="return CheckForm();">
...
<input type="hidden" name="hdnCount" id="hdnCount" value="'.$relsr.'">
</form>
</div>
</div>
</div>
...
<div class="row">
<div id="cursEditAnnoucementModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<form class="form-horizontal" action="#" method="post" id="editAnnoucement" enctype="multipart/form-data">
<div class="modal-content">
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
	<button type="button" class="full-screen-modal close" aria-hidden="true"><i class="icon-fullscreen"></i></button>
	<h4 class="modal-title" style="font-weight:700;"> Edit Course Announcement</h4>
</div>
...
<div class="modal-footer">
	<button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true">Close</button>
	<input type="hidden" id="annoucementid_edit" name="annoucementid_edit" value="">
	<input class="btn btn-primary" type="submit" value="Save Changes" id="changes_annoucements" name="changes_annoucements">
</div>
...
$(document).ready(function(){
    $(".edit-annoucement-modal").click(function(){
    

        var status_edit 		= $(this).attr("data-annoucement-status");
		var detail_edit 		= $(this).attr("data-annoucement-detail");
		var caption_edit 		= $(this).attr("data-annoucement-caption");
		var annoucementid_edit	= $(this).attr("data-annoucementid");

		$("#caption_edit")			.val(caption_edit);
		$("#detail_edit")			.val(detail_edit);
		$("#annoucementid_edit")	.val(annoucementid_edit);
