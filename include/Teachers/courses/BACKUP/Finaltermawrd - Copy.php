...
<tr class="inv_row">
	...
	<td style="width:70px;"><input type="number" class="form-control col-lg-12 jQinv_item_assign" min="0" max="10" id="assignment['.$srbk.']" name="assignment['.$srbk.']" required autocomplete="off" onkeypress="return isNumber(event)" style="text-align:center;"  value="'.$stdassignment.'"></td>
	<td style="width:70px;"><input type="number" class="form-control col-lg-12 jQinv_item_quiz" min="0" max="10" id="quiz['.$srbk.']" name="quiz['.$srbk.']" required autocomplete="off" onkeypress="return isNumber(event)" style="text-align:center;" value="'.$stdquiz.'"></td>
	<td style="width:70px;"><input type="number" class="form-control col-lg-12 jQinv_item_attendance" min="0" max="5" id="attendance['.$srbk.']" name="attendance['.$srbk.']" autocomplete="off" onkeypress="return isNumber(event)" style="text-align:center;" value="'.$stdattendance.'"></td>
	...
	<td style="width:70px;"><input type="number" class="form-control col-lg-12 jQinv_item_finalterm" min="0" max="50" id="finalterm['.$srbk.']" name="finalterm['.$srbk.']" required autocomplete="off" onkeypress="return isNumber(event)" style="text-align:center;" value="'.$stdfinalmarks.'"></td>
	...
	<td style="width:70px;"><input type="text" class="form-control col-lg-12 jQinv_item_numericalpoint" min="1" max="25" id="numerical['.$srbk.']" name="numerical['.$srbk.']" readonly style="text-align:center;" value="'.$stdnumerical.'"></td>
	...
	<td style="width:60px;"><input type="text" class="form-control col-lg-12 jQinv_item_totalgradepoint" id="gradepoint['.$srbk.']" name="gradepoint['.$srbk.']" readonly value="'.$stdgradepoint.'"></td>
