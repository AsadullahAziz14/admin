...
<div class="modal-header">
	...
	<h4 class="modal-title" style="font-weight:700;"> Course Objectives</h4>
</div>

<div class="modal-body">

	<div class="form-group">
		<label class="control-label req col-lg-12" style="width:150px;"><b> Objectives</b></label>
		<div class="col-lg-12">
			<textarea class="form-control ckeditor" id="objectives" name="objectives" style="height:150px !important;" required="required" autocomplete="off">'.$rowscinfo['objectives'].'</textarea>
		</div>
	</div>
...
<div class="modal-footer">
	...
	<input class="btn btn-primary" type="submit" value="Save Record" id="objectives_submit" name="objectives_submit">
</div>
