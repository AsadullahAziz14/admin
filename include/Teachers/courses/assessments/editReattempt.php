...
<div class="modal-header">
	<button type="button" class="close" onclick="location.href=\'courses.php?id='.$_GET['id'].'&prgid='.$_GET['prgid'].'&timing='.$_GET['timing'].'&semester='.$_GET['semester'].'&view=Assessments&reattempt&term='.$valueexam['id_term'].'\'"><span>close</span></button>
...
//------------------------------------------------
	...
	if($value_subjs['attachment']){  
		...
		echo '<p style="text-align:center;">
				<a class="btn btn-large btn-info" href="downloads/exams/answers/repeat/'.$value_subjs['attachment'].'" target="_blank">
					Attachment 
				</a>
				</p><br>';
	 }
...
<div class="modal-footer">
	<input class="btn btn-primary" type="submit" value="Save Changes" id="update_reattempt" name="update_reattempt">
	<button type="button" class="btn btn-default" onclick="location.href=\'courses.php?id='.$_GET['id'].'&prgid='.$_GET['prgid'].'&timing='.$_GET['timing'].'&semester='.$_GET['semester'].'&view=Assessments&reattempt&term='.$valueexam['id_term'].'\'" >Close</button>
</div>
