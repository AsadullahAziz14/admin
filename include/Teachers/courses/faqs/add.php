...
<div class="modal-header">
	...
	<h4 class="modal-title" style="font-weight:700;"> Add FAQs Lesson</h4>
</div>
...
<div class="modal-body">
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<input type="text" class="form-control" id="question" name="question" required autofocus autocomplete="off">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<textarea class="form-control" id="answer" name="answer" required autocomplete="off" style="height:70px !important;"></textarea>
		</div>
	</div>
