...
<form class="form-horizontal" action="courses.php?id='.$_GET['id'].'&view=FAQs" method="post" id="addLesson" enctype="multipart/form-data" OnSubmit="return CheckForm();">
<input type="hidden" name="editid" id="editid" value="'.cleanvars($_GET['editid']).'">
<div class="modal-content">
<div class="modal-header">
	<button type="button" class="close" onclick="location.href=\'courses.php?id='.$_GET['id'].'&view=FAQs\'"><span>close</span></button>
...
<div class="modal-body">
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<input type="text" class="form-control" id="question" name="question" required autofocus autocomplete="off" value="'.$rowlesson['question'].'">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<textarea class="form-control" id="answer" name="answer" required autocomplete="off" style="height:70px !important;">'.$rowlesson['answer'].'</textarea>
		</div>
	</div>
...
<div class="modal-footer">
	<input class="btn btn-primary" type="submit" value="Save Changes" id="changes_detailfaqs" name="changes_detailfaqs">
	<button type="button" class="btn btn-default" onclick="location.href=\'courses.php?id='.$_GET['id'].'&view=FAQs\'" >Close</button>
</div>
