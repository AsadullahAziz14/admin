...
<form class="form-horizontal" action="courses.php?id='.$_GET['id'].'&view=Lessonvideo" method="post" id="addLesson" enctype="multipart/form-data" OnSubmit="return CheckForm();">
<input type="hidden" name="editid" id="editid" value="'.cleanvars($_GET['editid']).'">
<div class="modal-content">
<div class="modal-header">
	<button type="button" class="close" onclick="location.href=\'courses.php?id='.$_GET['id'].'&view=Lessonvideo\'"><span>close</span></button>
	<h4 class="modal-title" style="font-weight:700;"> Edit Video Lesson Detail</h4>
</div>
...
<div class="modal-body">
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<textarea class="form-control" id="embedcode" name="embedcode" required autocomplete="off" style="height:50px !important;">'.$rowlesson['embedcode'].'</textarea>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<textarea class="form-control" id="detail" name="detail" autocomplete="off" style="height:50px !important;">'.$rowlesson['detail'].'</textarea>
		</div>
	</div>
...
<div class="modal-footer">
	<input class="btn btn-primary" type="submit" value="Save Changes" id="changes_detailvideo" name="changes_detailvideo">
	<button type="button" class="btn btn-default" onclick="location.href=\'courses.php?id='.$_GET['id'].'&view=Lessonvideo\'" >Close</button>
</div>
