...
<div class="modal-body">
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<textarea class="form-control" id="embedcode" name="embedcode" required autocomplete="off" style="height:70px !important;"></textarea>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<textarea class="form-control" id="detail" name="detail" autocomplete="off" style="height:70px !important;"></textarea>
		</div>
	</div>
