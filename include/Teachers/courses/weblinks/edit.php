...
<div class="modal-body">
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<input type="text" class="form-control" id="url" name="url" required autofocus autocomplete="off" value="'.$rowlesson['url'].'">
		</div>
	</div>
...
<div class="modal-footer">
	<input class="btn btn-primary" type="submit" value="Save Changes" id="changes_detailweblink" name="changes_detailweblink">
