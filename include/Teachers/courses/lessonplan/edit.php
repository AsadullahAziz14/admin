...
<form class="form-horizontal" action="courses.php?id='.$_GET['id'].'&view=Lessonplan" method="post" id="addLesson" enctype="multipart/form-data" OnSubmit="return CheckForm();">
<input type="hidden" name="editid" id="editid" value="'.cleanvars($_GET['editid']).'">
<div class="modal-content">
<div class="modal-header">
	<button type="button" class="close" onclick="location.href=\'courses.php?id='.$_GET['id'].'&view=Lessonplan\'"><span>close</span></button>
...
<div class="col-sm-61">
		<div class="form_sep">
			...
			<input type="text" class="form-control" id="weekno" name="weekno" required autocomplete="off" value="'.$rowlesson['weekno'].'" readonly>		
		</div> 
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<textarea class="form-control" id="detail" name="detail" required autocomplete="off" style="height:100px !important;">'.html_entity_decode($rowlesson['detail'], ENT_QUOTES).'</textarea>
		</div>
	</div>
	<div style="clear:both;"></div>';
if($countrelted>0) { 
...
<div class="modal-footer">
	<input class="btn btn-primary" type="submit" value="Save Changes" id="changes_detaillesson" name="changes_detaillesson">
	<button type="button" class="btn btn-default" onclick="location.href=\'courses.php?id='.$_GET['id'].'&view=Lessonplan\'" >Close</button>
</div>
