...
//------------------------------------------------
	...
	$rowlesson = mysqli_fetch_assoc($sqllmsannouce);
//------------------------------------------------	
...
<div class="modal-header">
	...
	<h4 class="modal-title" style="font-weight:700;"> Edit Course Announcement Detail</h4>
</div>
...
<div class="modal-body">
	...
	<div class="form-group">
		...
		<div class="col-lg-12">
			<textarea class="form-control" id="detail" name="detail" style="height:100px !important;" required autocomplete="off">'.$rowlesson['detail'].'</textarea>
		</div>
	</div>
...
<div class="modal-footer">
	<input class="btn btn-primary" type="submit" value="Save Changes" id="changes_detailannoucements" name="changes_detailannoucements">
