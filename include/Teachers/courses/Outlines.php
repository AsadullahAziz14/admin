...
<div class="row">
	<div class="col-lg-12">
		<div class="tabs-sub-nav">
			<span class="pull-left"><h3  style="font-weight:700;">Course Outlines</h3></span> <a class="btn btn-mid btn-purple pull-right" href="courses.php?id='.$_GET['id'].'"><i class="icon-list"></i> Back</a> 
...
//------------------------------------------------
if($rowscinfo['outlines']) {
	$outlines = $rowscinfo['outlines'];
} else {
	$outlines = $rowsurs['curs_detail'];
}
//-----------------------------------------
echo '
...
<div class="modal-header">
	...
	<h4 class="modal-title" style="font-weight:700;"> Course Outlines</h4>
</div>

<div class="modal-body">

	<div class="form-group">
		<label class="control-label req col-lg-12" style="width:150px;"><b> Outlines</b></label>
		<div class="col-lg-12">
			<textarea class="form-control ckeditor" id="outlines" name="outlines" style="height:150px !important;" required="required" autocomplete="off">'.$outlines.'</textarea>
		</div>
	</div>
...
<div class="modal-footer">
	...
	<input class="btn btn-primary" type="submit" value="Save Record" id="outlines_submit" name="outlines_submit">
</div>
