...
<ul id="nav" class="main-nav">
	...
	<li class="has_sub"> <a href="javascript:void(0)"> <i class="icon-file-text"></i> DSA System<span class="pull-right"><i class="icon-chevron-right" style="font-size:12px"></i></span></a>
		<ul>
			<li> <a href="dsaapplicationview.php"> <i class="icon-file-text"></i>DSA Home<span class="pull-right"></span></a> </li>
		</ul>
	</li>';
//-------------------------------------------------
