...
if (!LMS_VIEW && isset($_GET['id'])) {
   ...
   $sqllms = $dblms->querylms("SELECT * FROM " .SMS_VENDOR. " WHERE vendor_id =  ".cleanvars($_GET['id'])." ");
   ...
   <div class="row">
      <div class="modal-dialog" style="width:90%;">
         <form class="form-horizontal" action="vendors.php?id='.$_GET['id'].'" method="post" enctype="multipart/form-data">
            <div class="modal-content">
               ...
               <div class="modal-body">
				...
				<div class="col-sm-61">
					<div style="margin-top:5px;">
						...
						<input type="text" class="form-control" id="vendor_name" name="vendor_name" value="'.$rowstd['vendor_name'].'" required>	
					</div>
				</div>
				...
				<div class="col-sm-61">
					<div style="margin-top:5px;">
						...
						<input type="text" class="form-control" id="vendor_address" name="vendor_address" value="'.$rowstd['vendor_address'].'" required>
					</div>
				</div>
				...
				<div class="col-sm-31">
					<div style="margin-top:5px;">
						...
						<input type="text" class="form-control" id="vendor_contact_name" name="vendor_contact_name" value="'.$rowstd['vendor_contact_name'].'">
					</div>
				</div>
				...
				<div class="col-sm-31">
					<div style="margin-top:5px;">
						...
						<input type="email" class="form-control" id="vendor_contact_email" name="vendor_contact_email" value="'.$rowstd['vendor_contact_email'].'">
					</div>
				</div>
				...
				<div class="col-sm-31">
					<div style="margin-top:5px;">
						...
						<input type="text" class="form-control" id="vendor_contact_phone1" name="vendor_contact_phone1" value="'.$rowstd['vendor_contact_phone1'].'">
					</div>
				</div>
				...
				<div class="col-sm-31">
					<div style="margin-top:5px;">
						...
						<input type="text" class="form-control" id="vendor_contact_phone2" name="vendor_contact_phone2" value="'.$rowstd['vendor_contact_phone2'].'">
					</div>
				</div>
                        ...
                        {
                           if($rowstd['vendor_status'] == $itemadm_status['id']) {
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-default" onclick="location.href=\'vendors.php\'" >Close</button>
