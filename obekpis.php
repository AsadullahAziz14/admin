...
{   
	...
	echo '
			<title>Manage KPIs - '.TITLE_HEADER.'</title>
			<!-- Matter -->
			<div class="matter">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<form class="navbar-form navbar-left form-small" action="" method="get">
								...
								<a href="obekpis.php" class="btn btn-purple"><i class="icon-list"></i> All</a>';
								if((($_SESSION['userlogininfo']['LOGINTYPE'] == 1) || ($_SESSION['userlogininfo']['LOGINTYPE'] == 2) || Stdlib_Array::multiSearch($_SESSION['userroles'], array('right_name' => '19', 'add' => '1')))) {
									echo ' <a data-toggle="modal" class="btn btn-success" href="obekpis.php?view=add"><i class="icon-plus"></i> Add KPI</a>';
								}
								echo '
							</form>
						</div>
