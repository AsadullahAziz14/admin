  ...
  function () {
    return function () {
      ...
      function isUploaded(blobUri) {
        return hasBlobUri(blobUri) ? blobUriStatuses[blobUri].status === UOBE_PLOSADED : false;
      }
      ...
      function markUploaded(blobUri, resultUri) {
        blobUriStatuses[blobUri] = createStatus(UOBE_PLOSADED, resultUri);
      }
